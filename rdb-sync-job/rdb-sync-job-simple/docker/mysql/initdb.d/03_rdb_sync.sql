...
-- ----------------------------
INSERT INTO `pipeline_dist_mysql` VALUES ('simple_dist_mysql', 'mysql', 3306, 'test_dist', 'rdb_sync', 'rdb_sync', NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- ----------------------------
-- Records of pipeline_dist_starrocks
-- ----------------------------
INSERT INTO `pipeline_dist_starrocks` VALUES ('simple_dist_starrocks', 'starrocks', '9030', 'starrocks', '8080', 'dw_ods', 'rdb_sync', 'rdb_sync', NULL, NULL);
